...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
		...
		if ( 'post' === get_post_type() ) :
			...
			<div class="entry-meta">
				<?php
				fedeganaderos_posted_on();
				fedeganaderos_posted_by();
				?>
			</div><!-- .entry-meta -->
		<?php endif; ?>
	</header><!-- .entry-header -->

	<?php /*fedeganaderos_post_thumbnail();*/ ?>
	...
	<div class="entry-content">
		...
		the_content( sprintf(
			wp_kses(
				...
				__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'fedeganaderos' ),
				array(
					'span' => array(
						'class' => array(),
					),
		...
		wp_link_pages( array(
			'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'fedeganaderos' ),
			'after'  => '</div>',
		) );
		?>
	</div><!-- .entry-content -->
	...
	<footer class="entry-footer">
		<?php fedeganaderos_entry_footer(); ?>
	</footer><!-- .entry-footer -->
